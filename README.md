...
- [x] BTP cloud app deployment - JAVA (NOT INCLUDED) - due to java maven dependency frequent changes framework evolutionary changes and troubleshoot in deployment
...
- [x] Node approuter (NOT INCLUDED) - due to java maven dependency frequent changes framework evolutionary changes and troubleshoot in deployment
